...
$runtime = array(
    ...
    'display_num_entries' => $_SESSION['display_num_entries'],
    'display_num_trans' => $_SESSION['display_num_trans'],
    'display_num_accounts' => $_SESSION['display_num_accounts'],
    'selected_fiscal_period_id' => $_SESSION['selected_fiscal_period_id'],
