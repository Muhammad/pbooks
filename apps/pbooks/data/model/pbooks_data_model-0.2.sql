...
CREATE TABLE IF NOT EXISTS `pb_entries` (
  ...
  `fiscal_period_id` int(11) default '0',
  PRIMARY KEY  (`entry_id`),
  KEY `entry_datetime` (`entry_datetime`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3069 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11608 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6877 ;
...
--
-- Table structure for table `pb_notes`
--
...
CREATE TABLE IF NOT EXISTS `pb_notes` (
  ...
  `note_status_id` int(10) NOT NULL default '10',
  PRIMARY KEY  (`note_id`)
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1205 ;
