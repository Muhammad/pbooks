...
<table id="myLedger" class="tablesorter">
    ...
    <tr>
        ...
        <xsl:if test="(/_R_/_get/account_id='%' or not(/_R_/_get/account_id))">
            <th><xsl:value-of select="/_R_/i18n/label[key='account']/value"/></th>
        </xsl:if>
...
<xsl:value-of select="/_R_/i18n/label[key='account_ledger_links']/value"/>
    ...
    <a href="{/_R_/runtime/link_prefix}accounts-edit&amp;account_id={/_R_/_get/account_id}">
...
-->
<xsl:if test="(/_R_/_get/account_id='%' or
        not(/_R_/_get/account_id)) and
        not(contains(/_R_/_get/nid,'match')
        )">

<table class="tablesorter">
<thead>
<tr>
    <th><xsl:value-of select="/_R_/i18n/label[key='assets']/value"/> +</th>
    <th><xsl:value-of select="/_R_/i18n/label[key='expenses']/value"/> =</th>
    <th><xsl:value-of select="/_R_/i18n/label[key='sub_total']/value"/> =</th>
    <th><xsl:value-of select="/_R_/i18n/label[key='liabilities']/value"/> +</th>
    <th><xsl:value-of select="/_R_/i18n/label[key='equity']/value"/> +</th>
    <th><xsl:value-of select="/_R_/i18n/label[key='revenue']/value"/> = </th>
    <th><xsl:value-of select="/_R_/i18n/label[key='total']/value"/></th>
</tr>
</thead>
<tbody>
<tr>
